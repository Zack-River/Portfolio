...
const Testimonials: React.FC = () => {
  ...
  return (
    <section id="testimonials" className="py-24 md:py-32 bg-canvas-dark dark:bg-[#0D0F0E] text-canvas-light relative overflow-hidden transition-colors duration-500">
