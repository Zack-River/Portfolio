    ...
    >
      ...
      <div className="flex-1 min-w-0">
        <div className="flex items-center gap-1 mb-1">
          ...
          <span className="font-mono text-[8.5px] text-electric/80 uppercase tracking-widest">
            Voice Review
          </span>
        </div>
        <div
...
const Testimonials: React.FC = () => {
  // Duplicate testimonials for seamless infinite loop (3 sets)
  ...
  return (
    ...
    >
      <div className="absolute top-1/2 left-1/2 md:left-1/4 -translate-x-1/2 -translate-y-1/2 w-[70%] md:w-[45%] h-[70%] md:h-[60%] bg-electric/25 rounded-full blur-[140px] pointer-events-none z-0 hidden md:block animate-pulse"></div>
      ...
      <div className="relative z-10 mt-12 overflow-hidden cursor-default group">
        ...
        <div
          className="flex will-change-transform py-4 group-hover:[animation-play-state:paused]"
          style={{
          ...
          <style>
            {`
              ...
              @media (prefers-reduced-motion: reduce) {
                .group:hover .flex { animation-play-state: paused; }
                .flex { animation: none !important; transform: none !important; flex-wrap: wrap; justify-content: center; width: 100% !important; }
              }
            `}
          </style>
