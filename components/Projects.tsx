            ...
            .map((project, idx) => (
              ...
              >
                ...
                <div className="mt-5 mb-2 text-center flex flex-col items-center px-4">
                  ...
                  <span className="inline-flex items-center gap-2 text-electric font-medium bg-white/5 border border-electric group-hover:bg-electric/10 group-hover:shadow-[0_0_15px_rgba(180,255,0,0.2)] transition-all px-5 py-2 rounded-full text-sm">
