...
const Skills: React.FC = () => {
  return (
    <section id="skills" className="py-24 md:py-32 bg-canvas-dark text-canvas-light relative overflow-hidden">
      ...
      <div className="absolute top-1/2 left-1/2 md:left-3/4 -translate-x-1/2 -translate-y-1/2 w-[70%] md:w-[45%] h-[70%] md:h-[60%] bg-electric/15 rounded-full blur-[120px] pointer-events-none z-0"></div>
